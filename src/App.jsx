        ...
        <div className="a w-full">
          <div className="addtodo">
            ...
            <input
              type="text"
              placeholder="Todo"
              className="bg-white p-2 m-4 rounded-xl w-3/4"
              value={Todo}
            ...
            <button
              className="bg-violet-700 p-2 rounded-xl hover:bg-violet-900 text-white"
              onClick={HandleAdd}
            >
              {" "}
              Submit{" "}
            ...
            {Todos.map((item) => {
              return (
                (fininsh || !item.isComp) && (
                  <div
                    key={item.id}
                    className="todo flex justify-between w- rounded-xl p-2 bg"
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <label
                        className={item.isComp ? "m-2 line-through " : "m-2"}
                        text={item.Todo}
                      >
                        {item.Todo}
                      </label>
                    ...
                    <div className="flex space-x-2">
                      <button
                        className="bg-violet-700 p-2 rounded-xl hover:bg-violet-900 text-white m-2"
